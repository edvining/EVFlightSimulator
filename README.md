...
Khronos OpenGL (Open Graphics Library) is an Open-Source graphics library, enabling direct rendering to the screen, and whilst not as verbose as Vulkan, still enables good levels of performance.
